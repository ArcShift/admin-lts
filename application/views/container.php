...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <header class="main-header">
      <a class="logo">
	<span class="logo-mini"><b>Adm</b> Md</span>
	<span class="logo-lg"><b>Admin</b> Mode</span>
      </a>
      <nav class="navbar navbar-static-top">
	<div class="navbar-custom-menu"><!--left side-->
	  <ul class="nav navbar-nav">
		...
		<img src="<?php echo base_url(); ?>asset\AdminLTE\dist\img\avatar04.png" class="user-image" alt="User Image">
		<span class="hidden-xs">Username</span>
	      </a>
	      <ul class="dropdown-menu">
		<!-- User image -->
		<li class="user-header">
		  <img src="<?php echo base_url(); ?>asset\AdminLTE\dist\img\avatar04.png" class="img-circle" alt="User Image">
		  <p>
		    User - Super Admin
